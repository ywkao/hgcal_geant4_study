// -*- C++ -*-
//
// Package:    Demo/TrackAnalyzer
// Class:      TrackAnalyzer
//
/**\class TrackAnalyzer TrackAnalyzer.cc Track/TrackAnalyzer/plugins/TrackAnalyzer.cc
...
TrackAnalyzer::TrackAnalyzer(const edm::ParameterSet& iConfig)
 :
  tracksToken_(consumes<TrackCollection>(iConfig.getUntrackedParameter<edm::InputTag>("tracks1")))

{
   ...
   hPt = fs->make<TH1D>("hPt" , "hPt" , 1000 , 0. , 10. );
